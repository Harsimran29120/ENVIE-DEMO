    ...
    >
      ...
      >
        <div className="grid grid-count-6">
          ...
          <div className="grid-col">
            <span>{product.orariolunedi || <Skeleton width={50} />}</span>
          </div>
          <div className="grid-col">
            <span>{product.orariomartedi || <Skeleton width={50} />}</span>
          </div>
          <div className="grid-col">
            <span>{product.orariomercoledi || <Skeleton width={50} />}</span>
          </div>
          <div className="grid-col">
            <span>{product.orariogiovedi || <Skeleton width={50} />}</span>
          </div>
          <div className="grid-col">
            <span>{product.orariovenerdi || <Skeleton width={50} />}</span>
          </div>
          <div className="grid-col">
            <span>{product.orariosabato || <Skeleton width={50} />}</span>
          </div>
          <div className="grid-col">
            <span>{product.orariodomenica || <Skeleton width={50} />}</span>
          </div>
          <div className="grid-col">
